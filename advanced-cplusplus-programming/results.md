...
|     🐃 | 43/43 |      7/7 | 17/30 |      7/7 |  0/39 |      4/4 |  0/32 |    60/144 | 18/18 |         42% |    100% |
|     🐷 |  0/43 |      7/7 | 30/30 |      7/7 |  0/39 |      4/4 |  0/32 |    30/144 | 18/18 |         21% |    100% |
...
Last updated at 2026-05-11 10:22 - If some notes or exercise missing, please check first that you have uploaded with a correct naming scheme before contacting the teacher. This page is updated manually by the teacher, not automatically. May take some time, for example during weekends or holidays.
...
- 02: 0/7 FAIL
  ...
  ```
  compile error: /usr/bin/ld: /tmp/Main-d1a92e.o: in function `main':
  Main.cpp:(.text+0x0): multiple definition of `main'; /tmp/test-70cbf9.o:test.cpp:(.text+0x0): first defined here
...
- 04: 0/13 FAIL
  ...
  ```
  compile error: test.cpp:41:36: error: no member named 'getName' in 'Studio'
     41 |     check("Studio getName", studio.getName() == "Abbey Road");
        |                             ~~~~~~ ^
  ```
...
- 07: 0/4 FAIL
  ...
  ```
  compile error: /usr/bin/ld: /tmp/test-bb7ecb.o: in function `main':
...
- 01: 0/1 FAIL
  ...
  ```
  Missing screenshot.png in /work
  ```
...
- 07: 0/4 FAIL
  ...
  ```
  FAIL: toString format
  PASS: operator<< matches toString
  PASS: operator== false for different points
  ```
...
- 01: 0/6 FAIL
  ...
  ```
  FAIL: Point toString format
  FAIL: Line toString format
  PASS: Line length
  ```
...
- 04: 0/10 FAIL
  ...
  ```
  compile error: /usr/bin/ld: /tmp/Main-1d3281.o: in function `main':
  Main.cpp:(.text+0x0): multiple definition of `main'; /tmp/test-d433e3.o:test.cpp:(.text+0x0): first defined here
  clang++: error: linker command failed with exit code 1 (use -v to see invocation)
  ```
