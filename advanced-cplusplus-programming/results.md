...
Last updated at 2026-04-28 22:15 - If some notes or exercise missing, please check first that you have uploaded with a correct naming scheme before contacting the teacher.
...
- 02: 0/7 FAIL
  ...
  ```
  compile error: /usr/bin/ld: /tmp/Main-5d9542.o: in function `main':
  Main.cpp:(.text+0x0): multiple definition of `main'; /tmp/test-151702.o:test.cpp:(.text+0x0): first defined here
...
- 07: 0/4 FAIL
  ...
  ```
  compile error: /usr/bin/ld: /tmp/test-0afca8.o: in function `main':
