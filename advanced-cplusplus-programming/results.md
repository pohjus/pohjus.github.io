...
|     🐃 | 43/43 |      7/7 | 17/30 |      0/7 |  0/39 |      0/4 |  0/32 |    60/144 |  7/18 |         42% |     39% |
|     🐋 | 43/43 |      7/7 | 30/30 |      7/7 | 39/39 |      4/4 | 32/32 |   144/144 | 18/18 |        100% |    100% |
|     🦖 | 43/43 |      7/7 | 30/30 |      7/7 |  0/39 |      4/4 |  0/32 |    73/144 | 18/18 |         51% |    100% |
...
Last updated at 2026-04-29 15:28 - If some notes or exercise missing, please check first that you have uploaded with a correct naming scheme before contacting the teacher.
...
- 02: 0/7 FAIL
  ...
  ```
  compile error: /usr/bin/ld: /tmp/Main-d0d52b.o: in function `main':
  Main.cpp:(.text+0x0): multiple definition of `main'; /tmp/test-5faae5.o:test.cpp:(.text+0x0): first defined here
...
- 07: 0/4 FAIL
  ...
  ```
  compile error: /usr/bin/ld: /tmp/test-81208d.o: in function `main':
...
- 04: 0/10 FAIL
  ...
  ```
  compile error: /usr/bin/ld: /tmp/Main-fff8aa.o: in function `main':
  Main.cpp:(.text+0x0): multiple definition of `main'; /tmp/test-fa77a9.o:test.cpp:(.text+0x0): first defined here
  clang++: error: linker command failed with exit code 1 (use -v to see invocation)
  ```
