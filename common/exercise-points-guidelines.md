...
- Your own holiday trips for example is not a valid reason for skipping classes. Attending work is not considered an acceptable reason for being absent from classes. Our courses are designed with the assumption that students are full-time students, and study schedules should be prioritized accordingly.
