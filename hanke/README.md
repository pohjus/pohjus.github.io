# Tekoälyavusteisen ohjelmistokehityksen opintojaksokokonaisuus 15 op

**Tekoälyavusteisen ohjelmistokehityksen opintojaksokokonaisuudessa** harjoitellaan generatiivisen tekoälyn hyödyntämistä ohjelmistokehityksen eri vaiheissa. Opiskelija oppii määrittelemään ja
...
**Kokonaisuus koostuu kolmesta opintojaksosta**: 1) AI-Assisted Software Engineering, 2) Engineering AI-Enabled Applications ja 3) Agentic and Reliable AI Systems joiden suoritusjärjestys on seuraava:

```mermaid
flowchart LR
    A["AI-Assisted Software Engineering<br/>5 op"] -->|edeltää| B["Engineering AI-Enabled Applications<br/>5 op"]
    B -->|edeltää| C["Agentic and Reliable AI Systems<br/>5 op"]
```

Opintojaksot sisältävät laaja-alaisesti tekoälypohjaisen ohjelmistokehityksen. Opintojaksojen työnjako on kuvattu seuraavassa taulukossa:
...
- vertailla tekoälyavusteisia työskentelytapoja ja perustelee työskentelytavan
  valinnan tehtävän vaatimusten perusteella
- määritellä tehtävän vaatimukset, rajaukset ja hyväksymiskriteerit sekä
...
- arvioida tekoälyn tuottamia ratkaisuja ja varmistaa niiden laadun määrittelyjen,
  testien, katselmoinnin ja versionhallinnan avulla
- perustella, mistä ohjelmistokehittäjä vastaa, ja soveltaa tietoturvaa,
...
Opiskelija ymmärtää generatiivisen tekoälyn ja suurten kielimallien
toimintaperiaatteet ohjelmistokehittäjän tarvitsemalla tarkkuudella. Aiheisiin
kuuluvat tokenit, konteksti ja konteksti-ikkuna, mallien
...
vaikutuksia sekä etsii virheitä.
...
sekä poikkeus- ja rajatapaukset.
...
Opintojakso jatkaa AI-Assisted Software Engineering -opintojaksoa. Opintojaksolla suunnitellaan ja toteutetaan tekoälyominaisuuksia sisältäviä
...
- vertailla tapoja integroida kielimalleja sovellukseen ja perustelee mallin,
...
- määrittellä tehtäväkohtaiset onnistumiskriteerit ja arviointiaineiston sekä
  mittaa ratkaisun laatua, kustannuksia ja vasteaikaa
- analysoida generatiiviseen tekoälyyn perustuvan ominaisuuden
...
sovellusarkkitehtuuria. Opiskelija vertailee pilvipohjaisia ja paikallisesti suoritettavia
malleja. Käsiteltäviä aiheita ovat mallin valinta, pyyntöjen ja
...
valintaan ja vastauksen muodostamiseen.
...
kutsu suoritetaan sovelluksessa ja tulos palautetaan mallille.
...
vaihtoehtoiset toimintatavat tekoälypalvelun häiriöissä.
...
- vertailla agenttiarkkitehtuurien hyötyjä, kustannuksia ja monimutkaisuutta
...
- määritellä agentille vähimmät tarvittavat käyttöoikeudet,
...
- mitata järjestelmän laatua ja tietoturvaa.
...
Opiskelija arvioi tuotantovalmiutta koko agenttisen järjestelmän, ei yksittäisen
...
työkalukutsujen ja toimintakierrosten aikana.
