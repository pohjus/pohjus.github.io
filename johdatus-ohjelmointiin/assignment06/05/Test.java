...
void main() throws Exception {
    ...
    total++;
    var output = run("1\n4\n5\n1\n2\n3\n");
    if (output.contains("1 4 5") && output.contains("1 2 3")) {
        IO.println("  PASS: input 1,4,5,1,2,3 produces correct output");
        passed++;
    } else {
        IO.println("  FAIL: expected '1 4 5' and '1 2 3', got: " + output.trim());
    }
    ...
    total++;
    if (output.contains("2D array is:")) {
        IO.println("  PASS: output contains '2D array is:'");
        passed++;
    } else {
        IO.println("  FAIL: expected output to contain '2D array is:', got: " + output.trim());
    }
