...
| Classes, objects, encapsulation, constructors, equality, Swing | [Assignment 07](assignment07/) | 66 |
| Inheritance, abstract classes, interfaces, and Swing listeners | [Assignment 08](assignment08/) | 42 |
| **Total** | | **383** |

## Course Requirements

1. Watch lectures and submit handwritten notes for every lecture.
2. Complete assignmentnos (minimum 50%).
