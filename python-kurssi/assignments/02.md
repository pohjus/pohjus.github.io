...
Implement previous using for loops and `range()`.
...
- Time is between 08:00 and 21:59
- Money is at least 3€

Then print:

```bash
The café is open from 08:00 to 21:59. A coffee costs 3€. Go to the café.
```

Tip: use variables like `is_money_ok`, `is_time_ok`.
