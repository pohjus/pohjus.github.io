...
```
lastname-firstname-assignment05/while-loop1.py
lastname-firstname-assignment05/colours.py
...
lastname-firstname-assignment05/for-loop.py
```

You can decide the naming of \*.py files.
