...
Go through following tutorial. You do not need to use git (opposite to the instructions in the tutorial), just upload the assignments using [file upload](https://docs.google.com/forms/d/e/1FAIpQLScY4rGwSs_Rwe4GkkyJA7p1rWCO3U-ybHVbjP3FZsJTACinEA/viewform?usp=header).
