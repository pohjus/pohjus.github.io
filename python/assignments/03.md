...
Ask user for a word. Use a list to reverse the string and check if it's a palindrome.
...
Example:
    ...
    Enter items: apple,banana,apple,orange
    {'apple', 'banana', 'orange'}

---

#### 🤓 Extra assignment 23: Lotto App (5 p)
